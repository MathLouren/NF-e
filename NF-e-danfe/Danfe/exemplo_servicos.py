# exemplo_servicos.py
# Exemplo de como gerar uma NFe para SERVIÇOS
...
c.drawRightString(PAGE_W - MARGEM_H - 2*mm, y0 - 12*mm, "000.115.595")
...
# SERVIÇOS posicionados abaixo do transportador
y_produtos = y_transportador - 21*mm - 10*mm
# Para serviços: tipo="servico"
desenhar_produtos(c, x0=8*mm, y0=y_produtos, largura_total=194*mm, tipo="servico")
...
c.drawString(x0 + 1*mm, PAGE_H - MARGEM_H - 12*mm, "NF-e Nº 000.115.595 - SÉRIE 002")
...
# Salvar
c.save()
print(f"✅ PDF de SERVIÇOS gerado com 2 páginas: {PDF_PATH}") 